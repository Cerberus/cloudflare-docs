...
![Workers can use the fetch API to request external dependencies](../routing/media/custom-domains-dependencies.png)
...
![Custom Domains can stack on top of each other, like any external dependencies](../routing/media/custom-domains-subrequest.png)
...
![Custom Domains follow standard DNS ordering and matching logic](../routing/media/custom-domains-api-gateway.png)
...
![Routes can be run in front of Custom Domains](../routing/media/routes-with-custom-domains.png)
